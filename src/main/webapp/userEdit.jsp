		...
		<div class="card">
			...
			<form>
				...
				<fieldset class="form-group">
					...
					<input type="text" value="<c:out value='${user.password}' />" class="form-control" name="password">
				</fieldset>
				...
				<fieldset class="form-group">
					...
					<input type="text" value="<c:out value='${user.language}' />" class="form-control" name="language">
				</fieldset>
