	...
	class SeleniumTest {
		...
		public void checkRegisterTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/register.jsp");
		...
		public void checkLoginTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/login.jsp");
		...
		public void checkReviewManagementTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/ReviewServlet");
		...
		public void checkCreateReviewFormTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/create_review.jsp");
		...
		public void checkUserManagementTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/userManagement.jsp");
		...
		public void checkIndexTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/index.jsp");
		...
		public void checkUserEditTest() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/userEdit.jsp");
		...
		public void checkCommentManagementTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/CommentServlet");
		...
		public void checkCreateCommentTitle() {
			webDriver.navigate().to("http://localhost:8080/HelloWorldJavaEE/create_comment.jsp");
